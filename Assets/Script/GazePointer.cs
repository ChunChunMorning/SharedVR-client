...
public class GazePointer : MonoBehaviour, IGvrGazePointer
{
	...
	private GameObject m_gazeObject;
	...
	void Update()
	{
		...
		if (TouchManager.Down())
		{
			if (m_gazeObject != null)
			{
				var trigger = m_gazeObject.GetComponent<EventTrigger>();
			...
			SeManager.Instance.Play("default");
		}
	}
